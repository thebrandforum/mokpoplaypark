      ...
      if (result.success && result.data) {
        ...
        if (footer_settings) {
          setFooterSettings(prev => ({
            leftText: footer_settings.leftText || '',
            rightText: footer_settings.rightText || ''
          }))
        }
            ...
            <div className="p-3 sm:p-4 md:p-6 lg:p-4 xl:p-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2 p-2 bg-gray-50 rounded border">
                    <button
                      type="button"
                      onClick={() => {
                        const textarea = document.getElementById('leftTextArea') as HTMLTextAreaElement
                        const start = textarea.selectionStart
                        const end = textarea.selectionEnd
                        const selectedText = footerSettings.leftText.substring(start, end)
                        if (selectedText) {
                          const newText = footerSettings.leftText.substring(0, start) +
                            `<strong>${selectedText}</strong>` +
                            footerSettings.leftText.substring(end)
                          setFooterSettings({...footerSettings, leftText: newText})
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (selectedText) {
                          const newText = footerSettings.leftText.substring(0, start) +
                            `<span style="color: #0000FF;">${selectedText}</span>` +
                            footerSettings.leftText.substring(end)
                          setFooterSettings({...footerSettings, leftText: newText})
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (selectedText) {
                          const newText = footerSettings.leftText.substring(0, start) +
                            `<span style="color: #666666;">${selectedText}</span>` +
                            footerSettings.leftText.substring(end)
                          setFooterSettings({...footerSettings, leftText: newText})
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (selectedText) {
                          const newText = footerSettings.leftText.substring(0, start) +
                            `<span style="font-size: 18px;">${selectedText}</span>` +
                            footerSettings.leftText.substring(end)
                          setFooterSettings({...footerSettings, leftText: newText})
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (selectedText) {
                          const newText = footerSettings.leftText.substring(0, start) +
                            `<span style="font-size: 12px;">${selectedText}</span>` +
                            footerSettings.leftText.substring(end)
                          setFooterSettings({...footerSettings, leftText: newText})
                        }
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (selectedText) {
                          ...
                          alert('링크를 추가할 텍스트를 선택해주세요')
                        }
                      }}
                      className="px-3 py-1 bg-white border rounded hover:bg-gray-100 text-sm text-blue-600 font-medium"
                    >
                      🔗 링크
                    </button>
                  ...
                  <textarea
                    id="leftTextArea"
                    value={footerSettings.leftText}
                    onChange={(e) => setFooterSettings({...footerSettings, leftText: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500           focus:border-transparent resize-vertical text-sm font-mono"
                    rows={8}
                    placeholder="좌측에 표시할 내용을 입력하세요..."
                  />
                  ...
                  <div className="mt-2 p-3 bg-gray-50 border rounded">
                    ...
                    <div 
                      className="text-sm"
                      dangerouslySetInnerHTML={{ __html: footerSettings.leftText }}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2 p-2 bg-gray-50 rounded border">
                    <button
                      type="button"
                      onClick={() => {
                        const textarea = document.getElementById('rightTextArea') as HTMLTextAreaElement
                        const start = textarea.selectionStart
                        const end = textarea.selectionEnd
                        const selectedText = footerSettings.rightText.substring(start, end)
                        if (selectedText) {
                          const newText = footerSettings.rightText.substring(0, start) +
                            `<strong>${selectedText}</strong>` +
                            footerSettings.rightText.substring(end)
                          setFooterSettings({...footerSettings, rightText: newText})
                        }
                      }}
                      className="px-3 py-1 bg-white border rounded hover:bg-gray-100 text-sm font-bold"
                      style={{ color: '#000000' }}
                  ...
                  <textarea
                    id="rightTextArea"
                    value={footerSettings.rightText}
                    onChange={(e) => setFooterSettings({...footerSettings, rightText: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500           focus:border-transparent resize-vertical text-sm font-mono"
                    rows={8}
                    placeholder="우측에 표시할 내용을 입력하세요..."
                  />
                  ...
                  <div className="mt-2 p-3 bg-gray-50 border rounded">
                    ...
                    <div 
                      className="text-sm"
                      dangerouslySetInnerHTML={{ __html: footerSettings.rightText }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-xs text-blue-700">
                  💡 <strong>사용 방법:</strong> 텍스트를 드래그로 선택한 후 위의 버튼을 클릭하면 스타일이 적용됩니다.           링크는 URL을 입력받아 자동으로 추가됩니다.
                </p>
              </div>
