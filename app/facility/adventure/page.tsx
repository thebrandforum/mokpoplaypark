...
export default function AdventureFacilityPage() {
  ...
  const loadFacilityData = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/admin/facility?section=adventure')
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-20 pt-8 sm:pt-12">
        ...
        <div className="max-w-5xl mx-auto mb-6 sm:mb-8">
          <div className="text-center md:text-left">
            <div className="inline-flex space-x-4 sm:space-x-8 overflow-x-auto whitespace-nowrap">
              ...
              <a href="/facility/adventure" className="text-orange-500 border-b-2 border-orange-500 pb-1 px-2 font-medium text-sm sm:text-base">어드벤처코스</a>
              <a href="/facility/extreme" className="text-gray-600 hover:text-orange-500 px-2 font-medium text-sm sm:text-base">익스트림코스</a>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-lg lg:text-2xl font-bold text-gray-900 mb-4 text-center md:text-left">
            {facilityData?.subtitle || '스릴 만점 모험의 정점을 찍는 어드벤처코스'}
          </h2>
        </div>
