        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden mt-8">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 sm:p-6" style={{background: 'linear-gradient(90deg, #0060AF 0%, #0080DF 100%)'}}>
              ...
              <p className="text-white/90 text-sm text-center mt-1">(증빙 서류 지참 후 입장 시 현장에서 확인 필수)</p>
            </div>
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="text-sm sm:text-base font-semibold">목포 시민</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 주민등록증 또는 운전면허증, 등본(발급일자 3개월 이내, 목포 주소)
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-3 mt-0.5 font-bold">•</span>
                  <div>
                    <span className="text-sm sm:text-base font-semibold">국가유공자</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 국가유공자증 또는 유족증
                    </p>
                  </div>
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-3 mt-0.5 font-bold">•</span>
                  <div>
                    <span className="text-sm sm:text-base font-semibold">장애인</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 장애인 복지카드 또는 증명서
                    </p>
                  </div>
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-3 mt-0.5 font-bold">•</span>
                  <div>
                    <span className="text-sm sm:text-base font-semibold">기초생활 수급자</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 기초생활 수급자 증명서
                    </p>
                  </div>
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-3 mt-0.5 font-bold">•</span>
                  <div>
                    <span className="text-sm sm:text-base font-semibold">한부모가족</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 한부모 증명서
                    </p>
                  </div>
				...
				<li className="flex items-start">
                  <span className="text-blue-600 mr-3 mt-0.5 font-bold">•</span>
                  <div>
                    <span className="text-sm sm:text-base font-semibold">다자녀</span>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">
                      - 자녀 3인이상 가구
                    </p>
                  </div>
