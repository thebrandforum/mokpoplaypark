...
export default function BaseLayout({ children }: BaseLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 푸터 - 4단계 반응형 */}
      <footer className="bg-white py-6 sm:py-8 md:py-10 lg:py-10 xl:py-12 border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-sm">
            {/* 데스크톱: 좌우 2단, 모바일: 상하 배치 */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {/* 좌측 내용 */}
              <div className="text-left mb-4 md:mb-0 break-keep">
                {settings?.footer_settings?.leftText ? (
                  <div 
                    dangerouslySetInnerHTML={{ 
                      __html: settings.footer_settings.leftText
                    }}
                  />
                ) : (
                  <>
                    <strong>목포플레이파크</strong><br />
                    전라남도 목포시 남농로 115 (용해동) 목포플레이파크<br />
                    대표 : 홍주표 | 사업자등록번호 : 147-85-03093<br />
                    전화번호 : 061-272-8663<br />
                    이메일 : mokpoplaypark@climbkorea.com
                  </>
                )}
              </div>
              ...
              {/* 우측 내용 */}
              <div className="text-left mb-4 md:mb-0 break-keep">
                {settings?.footer_settings?.rightText ? (
                  <div 
                    dangerouslySetInnerHTML={{ 
                      __html: settings.footer_settings.rightText
                    }}
                  />
                ) : (
                  <>
                    <strong>온라인위탁사</strong><br />
                    서울시 강서구 화곡로 68길 82 강서IT밸리 1103호<br />
                    전화번호 : 02.338.1316<br />
                    통신판매업신고번호 : 2024-서울강서-0865
                  </>
                )}
              </div>
            </div>
